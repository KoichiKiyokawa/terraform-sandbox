...
type QueryResolver interface {
	Health(ctx context.Context) (*Message, error)
}
...
var sources = []*ast.Source{
	{Name: "../schema/main.gql", Input: `type Message {
  message: String!
}
...
func (ec *executionContext) _Query_health(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*Message)
	fc.Result = res
	return ec.marshalOMessage2ᚖappᚋgeneratedᚐMessage(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOMessage2ᚖappᚋgeneratedᚐMessage(ctx context.Context, sel ast.SelectionSet, v *Message) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
